...
export const About = () => {
  return (
    <div className="flex flex-col min-h-screen w-full bg-gray-200">
      <Header />
      <main className="flex-grow pt-24"> {/* Adjusted to pt-24 for fixed header */}
        <div className="mt-6 px-4 max-w-4xl mx-auto"> {/* Removed text alignment changes */}
          <h1 className="text-4xl font-bold text-black text-left">Who are we?</h1> {/* Ensured text alignment to left */}
          <p className="text-base text-black mt-4 text-left"> {/* Ensured text alignment to left */}
