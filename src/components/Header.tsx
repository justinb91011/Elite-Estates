  ...
  return (
    ...
    >
      ...
      <div style={{ marginRight: "1rem" }} className="flex items-center">
        <a href="mailto:EliteestatesLawncare@gmail.com" className="flex items-center text-white hover:text-white">
          <FontAwesomeIcon icon={faEnvelope} style={{ marginRight: "0.5rem" }} />
          Email Us
        </a>
        <span style={{ margin: "0 1rem" }}>|</span>
        <a href="tel:+16313772438" className="flex items-center text-white hover:text-white">
