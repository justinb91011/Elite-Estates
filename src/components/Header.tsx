...
export const Header = () => {
  return (
    <header
      className="fixed top-0 left-0 right-0 z-10 flex justify-between items-center w-full border-b bg-green-700 text-white"
      style={{ padding: "1rem" }}
    >
      ...
      <div style={{ marginRight: "1rem" }} className="flex items-center">
        {" "}
        {/* Right aligned contact info with icons */}
        <a
